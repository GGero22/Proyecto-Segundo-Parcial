...
<nav class="flex py-5 bg-black text-white">
        <div class="w-1/2 px-12 mr-auto">
            <p class="text-2x1 font-bold">Farmacia App</p>
        </div>
        ...
        <ul class="w-1/2 px-16 ml-auto flex justify-end pt-1">
            ...
            @if (auth()->check())
                    ...
                    <li>
                        <a href="{{route('login.destroy')}}" class="font-bold border-2 py-3 px-4 rounded-md bg-red-500 hover:bg-red-600 ">Logout</a>
                    </li>
